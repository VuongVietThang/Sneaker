    ...
    <div class="container">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="email" name="email" maxlength="255" class="form-control-file" accept="email/*" >
            ...
            <div class="form-group">
                ...
                <input type="text" id="phone" name="phone" maxlength="15" class="form-control-file" accept="phone/*"  oninput="validateOrderInput(this)">
            ...
            <div class="form-group">
                ...
                <input type="text" id="address" name="address"  class="form-control-file" accept="address/*" >
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" maxlength="255" class="form-control-file" accept="username/*" >
            ...
            <button class="btn btn-success mb-3" style="margin-bottom: 15px" type="submit" name="submit">ADD USER</button>
